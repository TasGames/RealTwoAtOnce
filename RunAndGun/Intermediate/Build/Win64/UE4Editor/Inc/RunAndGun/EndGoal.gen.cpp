...
// Cross Module References
	RUNANDGUN_API UClass* Z_Construct_UClass_AEndGoal_NoRegister();
	RUNANDGUN_API UClass* Z_Construct_UClass_AEndGoal();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_RunAndGun();
	RUNANDGUN_API UFunction* Z_Construct_UFunction_AEndGoal_OnBeginOverlap();
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEndGoal_Statics::NewProp_GoalBox_MetaData[] = {
		{ "Category", "Box" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "EndGoal.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AEndGoal_Statics::NewProp_GoalBox = { UE4CodeGen_Private::EPropertyClass::Object, "GoalBox", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x00400000000a0009, 1, nullptr, STRUCT_OFFSET(AEndGoal, GoalBox), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AEndGoal_Statics::NewProp_GoalBox_MetaData, ARRAY_COUNT(Z_Construct_UClass_AEndGoal_Statics::NewProp_GoalBox_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AEndGoal_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AEndGoal_Statics::NewProp_GoalBox,
	};
